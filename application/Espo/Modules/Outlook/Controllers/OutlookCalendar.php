...
class OutlookCalendar extends \Espo\Core\Controllers\Base
{
    public function postActionUsersCalendars($params, $data, $request)
    {
        return $this->getService('OutlookCalendar')->usersCalendars();
    }
}
