...
define('advanced:views/bpmn-flowchart/fields/flowchart', ['views/fields/base', 'model'], function (Dep, Model) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.wait(true);
            Espo.require('lib!client/modules/advanced/lib/espo-bpmn.js', () => this.wait(false));
        ...
        updateCreatedEntitiesDataUserTask: function (id, data) {
            var numberId = (id in this.createdEntitiesData) ?
        ...
        updateCreatedEntitiesData: function (id, actionList, targetType) {
            ...
            actionList.forEach(item => {
                ...
                var numberId = (eId in this.createdEntitiesData) ?
