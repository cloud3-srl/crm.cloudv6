...
define('outlook:views/outlook/fields/labeled-array', 'views/fields/array', function (Dep) {
            ...
            for (key in value) {
                ...
                if (label == null || label == '') {
                    if (hasEmptyIdentLabel) {
                        var msg = this.translate('fieldLabelIsRequired', 'messages','OutlookCalendar').replace('{field}', this.translate(this.name, 'fields', this.model.name));
