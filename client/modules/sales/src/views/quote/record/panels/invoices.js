...
Espo.define('sales:views/quote/record/panels/invoices', 'views/record/panels/relationship', function (Dep) {

    return Dep.extend({

        actionCreateRelatedInvoice: function () {
            this.notify('Loading...');
            Espo.Ajax.getRequest('Invoice/action/getAttributesFromQuote', {
