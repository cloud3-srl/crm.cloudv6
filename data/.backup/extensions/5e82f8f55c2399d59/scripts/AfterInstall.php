...
class AfterInstall
{
    ...
    protected function getIframeUrl($name)
    {
        ...
        if (method_exists('\\Espo\\Core\Utils\\Util', 'urlAddParam')) {
            return \Espo\Core\Utils\Util::urlAddParam($iframeUrl, $name, '3c74322a3a0810d0d8923995bc50d16d');
        }

        return $this->urlAddParam($iframeUrl, $name, '3c74322a3a0810d0d8923995bc50d16d');
    }
