...
class SalesOrderItem extends \Espo\Core\Controllers\Record
{
    public function actionCreate($params, $data, $request)
    {
        throw new Forbidden('Sales Order Item can be created only within Sales Order record.');
    }

    public function actionDelete($params, $data, $request)
    {
        throw new Forbidden('Sales Order Item can be deleted only with Sales Order record.');
    }
