...
Espo.define('sales:views/sales-order/fields/opportunity', 'views/fields/link', function (Dep) {
    ...
    return Dep.extend({
        ...
        select: function (model) {
            ...
            if (this.model.isNew()) {
                this.ajaxGetRequest('SalesOrder/action/getAttributesFromOpportunity', {
