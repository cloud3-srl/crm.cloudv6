...
class AfterInstall
{
    ...
    protected function getIframeUrl($name)
    {
        ...
        if (method_exists('\\Espo\\Core\Utils\\Util', 'urlAddParam')) {
            return \Espo\Core\Utils\Util::urlAddParam($iframeUrl, $name, '2f687f2013bc552b8556948039df639e');
        }

        return $this->urlAddParam($iframeUrl, $name, '2f687f2013bc552b8556948039df639e');
    }
