...
class OpportunityItem extends \Espo\Core\Controllers\Record
{
    public function actionCreate($params, $data, $request)
    {
        throw new Forbidden('Opportunity Item can be created only within Opportunity record.');
    }

    public function actionDelete($params, $data, $request)
    {
        throw new Forbidden('Opportunity Item can be deleted only within Opportunity record.');
    }
